<template>
		...
		<div class="container max-w-8xl mx-auto py-6 sm:px-6 lg:px-8">
				<div class="md:flex items-start">
						<div class="w-full md:w-3/12 sticky top-16">
								<div class="bg-white px-8">
										<ul class="space-y-6 py-6 widget-navigation w-full">
												<li class="navigation-item">
														<router-link custom :to="{name:'uyelik.show'}" v-slot="{href, route, navigate,isActive}">
																{{ isActive }}
																<a class="item cursor-pointer" :class="{active:isActive}">
												...
												<li class="navigation-item">
														<router-link custom :to="{name:'sepet.show'}" v-slot="{href, route, navigate,isActive}">
																{{ isActive }}
																<a class="item cursor-pointer" :class="{active:isActive}" @click="isOpen=!isOpen">
												...
												<li class="navigation-item">
														<router-link to="giris" class="item">
