<template>
 <div class="grid grid-cols-2 md:lg:xl:grid-cols-4 group ">
  <div class="p-10 flex flex-col items-center text-center group hover:bg-slate-50 cursor-pointer">
   ...
   <p class="text-xl font-medium text-slate-700 mt-3">Adres Defteri</p>
  </div>
  <div class="p-10 flex flex-col items-center text-center group hover:bg-slate-50 cursor-pointer">
   ...
   <p class="text-xl font-medium text-slate-700 mt-3">Alışveriş Sepetim</p>
  </div>
  <div class="p-10 flex flex-col items-center text-center group hover:bg-slate-50 cursor-pointer">
   ...
   <p class="text-xl font-medium text-slate-700 mt-3">Siparişlerim</p>
  </div>
  <div class="p-10 flex flex-col items-center text-center group hover:bg-slate-50 cursor-pointer">
  ...
  <div class="p-10 flex flex-col items-center text-center group hover:bg-slate-50 cursor-pointer">
   ...
   <p class="text-xl font-medium text-slate-700 mt-3">Genuine Visa Advice</p>
  </div>
 </div>
</template>
